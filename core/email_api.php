...
function email_format_bug_message( $p_visible_bug_data ) {
	...
	foreach( $p_visible_bug_data['bugnotes'] as $t_bugnote ) {
		...
		#LB/BFE 2015 
		# Email notifications: private Notizen kenntlich machen - https://issuetracking.bfe.tv/view.php?id=18088
		# enum in localization file: $s_view_state_enum_string = '10:öffentlich,50:privat';
		if($t_bugnote->view_state == 50) {
			$t_view_state_string = 'PRIVATE: ';
		} else {
			$t_view_state_string = '';
		}
		...
		#geändert LB/BFE 2015: Rolle des Nutzers aus Notizdarstellung entfernt ( . $t_access_level_string ), ( https://issuetracking.bfe.tv/view.php?id=18006 )	
		#geändert LB/BFE 2015: Hinweis auf private Notiz hinzugefügt - https://issuetracking.bfe.tv/view.php?id=18088
		#geändert LB/BFE 2015: Link zur Notiz entfernt - https://issuetracking.bfe.tv/view.php?id=18009
		$t_string = ' ('.$t_view_state_string . $t_formatted_bugnote_id . ') ' . user_get_name( $t_bugnote->reporter_id ) .' '. $t_last_modified . "\n" . $t_time_tracking; 
