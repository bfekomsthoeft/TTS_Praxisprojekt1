...
//	$g_jpgraph_path = '/var/www/mantis-1.2.2/jpgraph-3.0.7/src/';
	...
	# --- email variables -------------
	$g_administrator_email  = 'dominik_komsthoeft@yahoo.de';
	$g_webmaster_email      = 'dominik_komsthoeft@yahoo.de';
	...
	*/
	...
	$g_from_email           = 'dominik.komsthoeft@gmail.com';

	# the return address for bounced mail
	$g_return_path_email    = 'dominik_komsthoeft@yahoo.de';
...
//	$g_show_view			= ADVANCED_ONLY;
	...
	*/
	$g_css_include_file                             = '/css/bfe.css'; # LB/BFE 2015 - war leer ('') - behebt Fehler bei Error-Page: kein CSS - https://issuetracking.bfe.tv/view.php?id=18020
